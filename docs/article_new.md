...
На предложенные программой вопросы можно не отвечать, нажимая  клавишу `Enter`, если не хочется заполнять подробную информацию о проекте (особенно для нашего тестового проекта).
