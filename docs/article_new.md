...
Файл `package.json` в текущий момент у вас выглядит примерно так (версии пакетов у вас скорее всего будут другими в большую сторону, так как они постоянно обновляться):
